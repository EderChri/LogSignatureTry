...
def get_clf_metrics_nview(args, encoder, clf, loader, device):
    """Variant of get_clf_metrics for EncoderNView + ClassifierNView.

    Batch format from Load_DatasetNView:
